...
class CalendarControllerTest {
    ...
    void isoDateRangeParamsLimitRenderedEntriesToThatRange() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), "2026-07-01", "2026-07-31");
    ...
    void basicIsoDateRangeParamsLimitRenderedEntriesToThatRange() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), "20260701", "20260731");
    ...
    void reversedRangeParamsAreNormalizedAndStillLimitEntriesToThatRange() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), "2026-07-31", "2026-07-01");
    ...
    void missingRangeParamsRenderAllEntries() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), null, null);
    ...
    void unparseableRangeParamsAreIgnoredAndAllEntriesRender() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), "not-a-date", "07/31/2026");
    ...
    void onlyFromParamGivenLimitsRenderedEntriesToOnOrAfterThatDate() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), "2026-07-01", null);
    ...
    void onlyToParamGivenLimitsRenderedEntriesToOnOrBeforeThatDate() {
        ...
        ResponseEntity<String> response = controller.getCalendar(publicRequest(), null, "2026-07-31");
    ...
    private CalendarController controllerWith(CalendarEntry... entries) {
        ...
        return new CalendarController(new CalendarAggregator(
