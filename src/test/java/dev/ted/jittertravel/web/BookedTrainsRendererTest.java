...
class BookedTrainsRendererTest {
    ...
    void emptyListRendersEmptyStateMessage() {
        String html = BookedTrainsRenderer.render(List.of());

        assertThat(html).contains("No train trips booked yet.");
    }
    ...
    void trainWithMapsUrlRendersAsLink() {
        ...
        String html = BookedTrainsRenderer.render(List.of(train));
